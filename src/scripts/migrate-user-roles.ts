...
export async function migrateUserRoles(dataSource: DataSource) {
  ...
  try {
    ...
    console.log(`✓ Migrated ${salesExecutives.affected} Sales Executive users to Account Manager`);
    ...
    console.log(`✓ Migrated ${operations.affected} Operations users to Delivery Manager`);
